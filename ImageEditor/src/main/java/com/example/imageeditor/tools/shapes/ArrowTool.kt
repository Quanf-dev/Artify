...
class ArrowTool : BaseTool() {
    ...
    private var currentDrawable: ArrowDrawable? = null
    ...
    private fun updateDrawablePath() {
        currentDrawable?.updateArrow(startX, startY, currentX, currentY)
    }
...
class ArrowDrawable(
    ...
    fun updateArrow(startX: Float, startY: Float, endX: Float, endY: Float) {
        path.reset()
        ...
        // Left arrow head
        val leftX = endX - arrowLength * cos(angle + arrowAngle)
        val leftY = endY - arrowLength * sin(angle + arrowAngle)
        path.moveTo(endX, endY)
        path.lineTo(leftX, leftY)
        
        // Right arrow head
        val rightX = endX - arrowLength * cos(angle - arrowAngle)
        val rightY = endY - arrowLength * sin(angle - arrowAngle)
        path.moveTo(endX, endY)
